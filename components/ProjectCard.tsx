        ...
        <div className="flex flex-col py-6 gap-6 w-96 max-w-sm rounded overflow-hidden shadow-lg border border-emerald-600">
            ...
            <div className="px-2">
                <div className="flex justify-center space-x-4 sm:space-x-12">
                    <a className="shadow-sm flex items-center p-1 rounded-lg text-sm border border-green-600 bg-green-300 active:bg-emerald-500 hover:bg-emerald-400 focus:ring-1 focus:ring-gray-600 focus:outline-none" href={gitHubUrl + repoName} target="_blank" rel="noreferrer"><BsGithub className="inline mx-1"/> See code</a>
                    {siteUrl && <a className="shadow-sm flex items-center p-1 rounded-lg text-sm border border-green-600 bg-green-300 active:bg-emerald-500 hover:bg-emerald-400 focus:ring-1 focus:ring-gray-600 focus:outline-none" href={siteUrl} target="_blank" rel="noreferrer"><FiExternalLink className="inline mx-1"/> Visit site</a>}
                </div>
            </div>
        </div>
    )
