      ...
      <main className='snap-y snap-mandatory scroll-smooth h-screen w-full overflow-y-scroll'>
        ...
        {({ inView, ref, entry }) => (
          <section id="about" ref={ref} className='snap-start bg-amber-400 w-full h-full flex flex-col overflow-y-auto p-8'>
            ...
            <div className={`text-base space-y-6 my-6 self-center sm:mt-12 sm:mb-24 ${inView ? 'animate-slideInUp animate-faster' : ''}`}>
              ...
              <h2 className={`text-center font-normal text-xl text-md sm:text-4xl sm:mb-2 sm:font-light ${inView ? 'animate-zoomIn animate-faster' : ''}`}>Tools I use</h2>
              <div className="flex justify-center">
                <div className={`flex flex-wrap max-w-3xl p-2 justify-center gap-0 sm:gap-x-10 gap-y-4 ${inView ? 'animate-zoomIn animate-faster' : ''}`}>
        ...
        {({ inView, ref, entry }) => (
          <section id="projects" ref={ref} className='snap-start bg-teal-500  w-full h-full flex flex-col overflow-y-auto p-8'>
            ...
            <p className={`text-xs font-thin self-center mb-4 sm:text-base ${inView ? 'animate-slideInRight animate-faster sm:animate-slideInUp' : ''}`}> Most of my work are things I can not share here due to client confidentiality. However, I have more personal projects that will be added soon.</p>
